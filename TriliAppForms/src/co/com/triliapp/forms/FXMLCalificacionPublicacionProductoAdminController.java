 ...
 * @author yasuly
 */
public class FXMLCalificacionPublicacionProductoAdminController implements Initializable {
    ...
    @FXML
    public void RegresarCalificaciones(ActionEvent event) throws Exception {
